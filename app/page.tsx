...
export default function Home() {
  return (
    <main>
      <div>
        <div className="absolute inset-x-0 top-28 -z-10 transform-gpu overflow-hidden
        ...
        <div className="py-12 sm:py-20 lg:pb-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-4xl font-bold tracking sm:text-6xl">
                Chat With Anyone anywhere!
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                You speak your langage they speak their language.{" "}
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
               ...
               text-white dark:text-white shadow-sm hover:bg-indigo-500
            ...
            <div className="mt-16 flow-root sm:mt-24">
              ...
              ring-gray-900/10 lg:-m-4:rounded-2xl lg:p-4">
                <Image
                unoptimized
                src={DemoGif}
                  alt="App screensot"
        ...
        <div className="absolute insert-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu
        overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]
      " aria-hidden="true">

        <div className="relative left-[calc(50%+13rem)] aspect-[1155/678] 
